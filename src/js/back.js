...
export function createBackPoints(params) {
  ...
  const pointsEF_BD = convertEFtoBD(pointsB, pointsC);
  ...
  const pointsCornersAB_BD = convertCornersABtoBD(cornerC_CD, cornerAB);
  ...
  const pointsCornersCD_BD = convertCornersCDtoBD(
    cornerA_CD,
    cornerB_CD,
    cornerC_CD,
    cornerAB
  ...
  const pointsCornersEF_BD = convertCornersEFtoBD(cornerB_CD);
  ...
  const pointsEF_BU = convertEFtoBU(pointsB, pointsC);
  ...
  const pointsCornersAB_BU = convertCornersABtoBU(cornerC_CD, cornerAB);
  ...
  const pointsCornersCD_BU = convertCornersCDtoBU(
    cornerA_CD,
    cornerB_CD,
    cornerC_CD,
    cornerAB
  ...
  const pointsCornersEF_BU = convertCornersEFtoBU(cornerB_CD);
  ...
  const pointsEF_BR = convertEFtoBR(pointsB, pointsC);
  ...
  const pointsEF_BL = convertEFtoBL(pointsB, pointsC);
  // console.log('pointsEF_BL', pointsEF_BL);

  // console.log(pointsA, pointsB, pointsC);
  const pointsCD_BD = convertCDtoBD(pointsA, pointsB, pointsC);
  const pointsCD_BU = convertCDtoBU(pointsA, pointsB, pointsC);
  const pointsCD_BR = convertCDtoBR(pointsA, pointsB, pointsC);
  const pointsCD_BL = convertCDtoBL(pointsA, pointsB, pointsC);
