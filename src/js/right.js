...
// // return pointsEF_RU = convertEFtoRU(pointsA, pointsB, pointsC);
...
export function createRightPoints(params) {
  ...
  const pointsEF_RU = convertEFtoRU(pointsA, pointsB, pointsC);
  // return pointsEF_RU = convertEFtoRU(pointsA, pointsB, pointsC);
  // console.log('pointsEF_RU', pointsEF_RU);
  ...
  const pointsCornersAB_RU = convertCornersABtoRU(cornerC_CD, cornerAB);
  // console.log('pointsCornersAB_RU', pointsCornersAB_RU);
  ...
  const pointsCornersCD_RU = convertCornersCDtoRU(
    cornerA_CD,
    cornerB_CD,
    cornerC_CD,
    cornerAB
  ...
  const pointsCornersEF_RU = convertCornersEFtoRU(
    cornerA_CD,
    cornerB_CD,
    cornerC_CD
  );
  ...
  const pointsEF_RD = convertEFtoRD(pointsA, pointsB, pointsC);
  // console.log('pointsEF_RD', pointsEF_RD);
  ...
  const pointsCornersAB_RD = convertCornersABtoRD(cornerC_CD, cornerAB);
  // console.log('pointsCornersAB_RD', pointsCornersAB_RD);
  ...
  const pointsCornersCD_RD = convertCornersCDtoRD(
    cornerA_CD,
    cornerB_CD,
    cornerC_CD,
    cornerAB
  ...
  const pointsCornersEF_RD = convertCornersEFtoRD(
    cornerA_CD,
    cornerB_CD,
    cornerC_CD
  );
  ...
  const pointsEF_RF = convertEFtoRF(pointsA, pointsB, pointsC);
  // console.log('pointsEF_RF', pointsEF_RF);
  ...
  const pointsEF_RB = convertEFtoRB(pointsA, pointsB, pointsC);
  // console.log('pointsEF_RB', pointsEF_RB);

  // console.log(pointsA, pointsB, pointsC);
  const pointsCD_RF = convertCDtoRF(pointsA, pointsB, pointsC);
  const pointsCD_RB = convertCDtoRB(pointsA, pointsB, pointsC);
  const pointsCD_RU = convertCDtoRU(pointsA, pointsB, pointsC);
  const pointsCD_RD = convertCDtoRD(pointsA, pointsB, pointsC);
  // console.log('pointsCD_RF', pointsCD_RF);
  // console.log('pointsCD_RB', pointsCD_RB);
  // console.log('pointsCD_RU', pointsCD_RU);
  // console.log('pointsCD_RD', pointsCD_RD);
