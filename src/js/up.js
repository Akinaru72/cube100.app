...
//   fullsize,
// } from './constants.js';
export function createUpPoints(params) {
  ...
  const pointsEF_UB = convertEFtoUB(pointsB, pointsC);
  ...
  const pointsCornersAB_UB = convertCornersABtoUB(cornerC_CD, cornerAB);
  ...
  const pointsCornersCD_UB = convertCornersCDtoUB(
    cornerA_CD,
    cornerB_CD,
    cornerC_CD,
    cornerAB
  ...
  const pointsCornersEF_UB = convertCornersEFtoUB(cornerB_CD);
  ...
  const pointsEF_UF = convertEFtoUF(pointsB, pointsC);
  ...
  const pointsCornersAB_UF = convertCornersABtoUF(cornerC_CD, cornerAB);
  ...
  const pointsCornersCD_UF = convertCornersCDtoUF(
    cornerA_CD,
    cornerB_CD,
    cornerC_CD,
    cornerAB
  ...
  const pointsCornersEF_UF = convertCornersEFtoUF(cornerB_CD);
  ...
  const pointsEF_UR = convertEFtoUR(pointsB, pointsC);
  ...
  const pointsEF_UL = convertEFtoUL(pointsB, pointsC);
  // console.log('pointsEF_UL', pointsEF_UL);

  // console.log(pointsA, pointsB, pointsC);
  const pointsCD_UB = convertCDtoUB(pointsA, pointsB, pointsC);
  const pointsCD_UF = convertCDtoUF(pointsA, pointsB, pointsC);
  const pointsCD_UR = convertCDtoUR(pointsA, pointsB, pointsC);
  const pointsCD_UL = convertCDtoUL(pointsA, pointsB, pointsC);
